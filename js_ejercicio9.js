...
const rutaSinCheck = "/entregaejercicios/images/eje9-iconos/sin_check.svg";
const rutaConCheck = "/entregaejercicios/images/eje9-iconos/con_check.svg";
...
function pintaTareaEnDom(texto) {
  ...
  nwLi.innerHTML = `
      <a href="#" style="display: flex; align-items: flex-start; margin-top: 3px; flex-shrink: 0;">
          <img class="check" src="/entregaejercicios/images/eje9-iconos/sin_check.svg" alt="" />
        </a>
